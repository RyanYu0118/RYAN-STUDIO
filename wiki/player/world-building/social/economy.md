...
description: 流浪世界社会科学·第6章：价值从何而来，货币如何流动，市场与网页层如何衔接。
...
本文是「社会科学」编年中的**经济专章**（对应总纲 6.1–6.7），并说明这些设定在服务器里**实际由哪些机制承载**。游玩操作仍以 [经济与商店](/archives/player/economy) 为准；物价数字见 [物品价格一览](/archives/player/server-world/prices)。
...
- [社会科学 · 总纲](/archives/wwswiki_worldbuilding_social) — 第 6 节索引  
