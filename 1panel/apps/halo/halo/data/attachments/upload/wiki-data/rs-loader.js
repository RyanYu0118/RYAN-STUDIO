...
(function() {
    ...
    if (location.pathname.indexOf("/console") === 0) {
        ...
        function bootConsoleWiki() {
            ...
            var WIKI_VER = "2.6";
            var HTML_VER = "3.4.2";
            var EDIT_SCROLL_VER = "1.1.2";
            var PUBLISH_VER = "1.3";
            var ARCHIVE_SCROLL_VER = "1.0.2";
            ...
            loadConsoleScript("/upload/wiki-data/rs-config.js?v=3", function () {
                ...
                loadConsoleScript("/upload/wiki-data/rs-console-edit-scroll.js?v=1.1.2");
    ...
    loadScript(SCRIPTS.config, function() {
        ...
        if (path.indexOf("/archives/") === 0) {
            ...
            loadScript("/upload/wiki-data/rs-archive-scroll.js?v=1.0.2");
        } else {
            initQuickEdit();
        }
